...
function add() {
  ...
  setInterval(function(){
    if(width>30 && width<=60){
      var damage = document.getElementById('health2');
      damage.style.background='rgb(255, 191, 0)';
...
$(document).on('keydown keyup',function (e){
    if(e.type=='keydown'){
        ...
        if (e.keyCode == 39) { if($kenPos.left<$guilePos.left-50){walkRight(); }}
        //punch
...
setInterval(function(){
    if($guile.hasClass('hit1') || $guile.hasClass('hit2') || $guile.hasClass('hit2')){
        update();
    }
},500);
setInterval(function(){
...
var fball = function(){
    ...
    setTimeout(function(){
        ...
        var explodeIfColision=setInterval(function(){
            ...
            if($fireballPos.left>=$guilePos.left){
                 x=1;
                $guile.addClass('hit2');
                setTimeout(function(){hitcount++;$guile.removeClass('hit2');},500);
