...
$(document).on('keydown keyup',function (e){
    if(e.type=='keydown'){
        ...
        if (e.keyCode == 39) { if($kenPos.left<$guilePos.left-99){walkRight(); }}
        //punch
...
var punch = function (){
      $ken.addClass('punch');
      if(isColision() || $kenPos.left>($guilePos.left-120)){
          $guile.addClass('hit1');
...
var fball = function(){
    ...
    setTimeout(function(){
        ...
        var explodeIfColision=setInterval(function(){
            ...
            if($fireballPos.left>=$guilePos.left-50){
                 x=1;
                $guile.addClass('hit2');
                setTimeout(function(){hitcount++;$guile.removeClass('hit2');},500);
